...
Vide, borne incluse, doublon et valeur absente font partie du contrat, pas d’une correction tardive. Une table de cas précède l’implémentation.

## Explication

Vide, borne incluse, doublon et valeur absente font partie du contrat, pas d’une correction tardive. Une table de cas précède l’implémentation. La règle doit rester visible dans le nom des opérations, les bornes et les erreurs. Avant de coder, notez l’entrée, la sortie, les invariants et ce qui doit être refusé.

## Exemple commenté

Pour compter des jours ouvrés, la table couvre même jour, week-end, ordre inversé et intervalle traversant deux semaines. L’exemple est volontairement petit : changez une borne et une valeur absente pour vérifier que le raisonnement, et non la donnée mémorisée, produit le résultat.

## Contre-exemple et erreur fréquente

Tester seulement l’exemple nominal autorise les erreurs de borne et les réponses codées en dur. Le contre-exemple doit être reproduit par un test qui échoue avant correction et réussit après.
