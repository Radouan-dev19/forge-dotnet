...
Une jointure combine des lignes selon une relation. INNER exclut les absences ; LEFT conserve le côté gauche et exige un traitement explicite de null.

## Explication

Une jointure combine des lignes selon une relation. INNER exclut les absences ; LEFT conserve le côté gauche et exige un traitement explicite de null. La règle doit rester visible dans le nom des opérations, les bornes et les erreurs. Avant de coder, notez l’entrée, la sortie, les invariants et ce qui doit être refusé.

## Exemple commenté

Un LEFT JOIN suivi d’un filtre sur la table droite dans WHERE peut devenir involontairement un INNER JOIN. L’exemple est volontairement petit : changez une borne et une valeur absente pour vérifier que le raisonnement, et non la donnée mémorisée, produit le résultat.

## Contre-exemple et erreur fréquente

Joindre sans comprendre la cardinalité multiplie les lignes et fausse les agrégats. Le contre-exemple doit être reproduit par un test qui échoue avant correction et réussit après.
