# Transformer le parcours en preuves de carrière honnêtes
...
CV, réponses STAR et suivi de candidatures utilisent des faits vérifiables, minimisent les données personnelles et nʼannoncent ni emploi ni salaire garanti. Le plan post-embauche reste un plan, pas un parcours livré.

## Explication

CV, réponses STAR et suivi de candidatures utilisent des faits vérifiables, minimisent les données personnelles et nʼannoncent ni emploi ni salaire garanti. Le plan post-embauche reste un plan, pas un parcours livré. Écrivez dʼabord le contrat, les entrées non fiables, la responsabilité exacte, les coûts possibles et la méthode de suppression. Une étape manuelle reste annoncée comme manuelle.

## Exemple commenté

Une ligne de CV cite un problème, une action, une preuve et une portée exacte ; une réponse STAR distingue contribution personnelle et résultat collectif. Faites varier une contrainte et expliquez pourquoi le choix pourrait alors changer.

## Contre-exemple et erreur fréquente

Inventer une métrique, publier une adresse personnelle ou présenter un laboratoire comme une expérience professionnelle trompe le lecteur. Reproduisez le défaut avec une preuve locale avant de proposer une correction.
