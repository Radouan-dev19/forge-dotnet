...
Watch et Locals servent à comparer attendu et réel. Une expression d’observation ne doit pas modifier la collection étudiée.

## Explication

Watch et Locals servent à comparer attendu et réel. Une expression d’observation ne doit pas modifier la collection étudiée. La règle doit rester visible dans le nom des opérations, les bornes et les erreurs. Avant de coder, notez l’entrée, la sortie, les invariants et ce qui doit être refusé.

## Exemple commenté

Copier un tableau avant un tri exploratoire préserve l’entrée et permet de comparer les deux états. L’exemple est volontairement petit : changez une borne et une valeur absente pour vérifier que le raisonnement, et non la donnée mémorisée, produit le résultat.

## Contre-exemple et erreur fréquente

Appeler une méthode mutante depuis Watch change le programme que l’on cherche à comprendre. Le contre-exemple doit être reproduit par un test qui échoue avant correction et réussit après.
