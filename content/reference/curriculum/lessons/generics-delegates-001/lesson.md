...
Un générique conserve le type lorsque l’algorithme ne dépend pas d’un type concret. Un delegate injecte un comportement court et explicite.

## Explication

Un générique conserve le type lorsque l’algorithme ne dépend pas d’un type concret. Un delegate injecte un comportement court et explicite. La règle doit rester visible dans le nom des opérations, les bornes et les erreurs. Avant de coder, notez l’entrée, la sortie, les invariants et ce qui doit être refusé.

## Exemple commenté

Une transformation applique une fonction à chaque entier et produit une nouvelle collection sans connaître la formule. L’exemple est volontairement petit : changez une borne et une valeur absente pour vérifier que le raisonnement, et non la donnée mémorisée, produit le résultat.

## Contre-exemple et erreur fréquente

Employer object puis caster partout reporte les erreurs à l’exécution et obscurcit le contrat. Le contre-exemple doit être reproduit par un test qui échoue avant correction et réussit après.
