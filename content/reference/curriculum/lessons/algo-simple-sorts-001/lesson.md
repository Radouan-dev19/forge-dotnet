...
Les tris insertion, sélection et bulles illustrent des invariants différents. Ils servent à expliquer correction et coût, pas à remplacer Array.Sort en production.

## Explication

Les tris insertion, sélection et bulles illustrent des invariants différents. Ils servent à expliquer correction et coût, pas à remplacer Array.Sort en production. La règle doit rester visible dans le nom des opérations, les bornes et les erreurs. Avant de coder, notez l’entrée, la sortie, les invariants et ce qui doit être refusé.

## Exemple commenté

Après chaque tour du tri par sélection, le préfixe est trié et contient les plus petits éléments. L’exemple est volontairement petit : changez une borne et une valeur absente pour vérifier que le raisonnement, et non la donnée mémorisée, produit le résultat.

## Contre-exemple et erreur fréquente

Échanger au mauvais indice peut conserver les mêmes valeurs tout en laissant l’ordre incorrect. Le contre-exemple doit être reproduit par un test qui échoue avant correction et réussit après.
