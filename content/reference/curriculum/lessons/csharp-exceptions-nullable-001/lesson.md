...
Une valeur absente attendue se modélise ; une violation de contrat se refuse. Le type nullable et l’exception ne sont pas deux orthographes du même état.

## Explication

Une valeur absente attendue se modélise ; une violation de contrat se refuse. Le type nullable et l’exception ne sont pas deux orthographes du même état. La règle doit rester visible dans le nom des opérations, les bornes et les erreurs. Avant de coder, notez l’entrée, la sortie, les invariants et ce qui doit être refusé.

## Exemple commenté

Une recherche retourne null quand l’absence est normale, alors qu’une quantité négative déclenche ArgumentOutOfRangeException. L’exemple est volontairement petit : changez une borne et une valeur absente pour vérifier que le raisonnement, et non la donnée mémorisée, produit le résultat.

## Contre-exemple et erreur fréquente

Attraper Exception puis retourner zéro efface la cause et fabrique une donnée valide. Le contre-exemple doit être reproduit par un test qui échoue avant correction et réussit après.
