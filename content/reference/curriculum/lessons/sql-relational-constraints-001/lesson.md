...
Une clé primaire identifie, une clé étrangère relie et une contrainte protège une règle au plus près des données. Les types reflètent le domaine.

## Explication

Une clé primaire identifie, une clé étrangère relie et une contrainte protège une règle au plus près des données. Les types reflètent le domaine. La règle doit rester visible dans le nom des opérations, les bornes et les erreurs. Avant de coder, notez l’entrée, la sortie, les invariants et ce qui doit être refusé.

## Exemple commenté

Orders référence Customers et interdit un total négatif ; une ligne orpheline est rejetée par la base. L’exemple est volontairement petit : changez une borne et une valeur absente pour vérifier que le raisonnement, et non la donnée mémorisée, produit le résultat.

## Contre-exemple et erreur fréquente

Compter sur l’interface seule permet à un autre chemin d’écriture de créer des données incohérentes. Le contre-exemple doit être reproduit par un test qui échoue avant correction et réussit après.
