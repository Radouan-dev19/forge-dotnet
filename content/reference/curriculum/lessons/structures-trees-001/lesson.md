...
Un arbre relie un nœud à des enfants sans cycle. Profondeur, hauteur et ordre de parcours doivent être définis avant l’algorithme.

## Explication

Un arbre relie un nœud à des enfants sans cycle. Profondeur, hauteur et ordre de parcours doivent être définis avant l’algorithme. La règle doit rester visible dans le nom des opérations, les bornes et les erreurs. Avant de coder, notez l’entrée, la sortie, les invariants et ce qui doit être refusé.

## Exemple commenté

Un parcours en largeur utilise une file ; un parcours en profondeur peut utiliser une pile ou une récursion bornée. L’exemple est volontairement petit : changez une borne et une valeur absente pour vérifier que le raisonnement, et non la donnée mémorisée, produit le résultat.

## Contre-exemple et erreur fréquente

Confondre index de tableau et identité de nœud donne des résultats corrects seulement pour un arbre complet. Le contre-exemple doit être reproduit par un test qui échoue avant correction et réussit après.
