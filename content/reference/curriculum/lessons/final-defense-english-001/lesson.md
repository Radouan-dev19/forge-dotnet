# Défendre une architecture en anglais professionnel
...
Une défense courte annonce le problème, le choix, la preuve, la limite et la prochaine expérience. Le vocabulaire technique reste précis ; lʼaccent nʼest pas un critère de maîtrise.

## Explication

Une défense courte annonce le problème, le choix, la preuve, la limite et la prochaine expérience. Le vocabulaire technique reste précis ; lʼaccent nʼest pas un critère de maîtrise. Écrivez dʼabord le contrat, les entrées non fiables, la responsabilité exacte, les coûts possibles et la méthode de suppression. Une étape manuelle reste annoncée comme manuelle.

## Exemple commenté

The application remains a modular monolith because one team owns one transactional boundary; integration tests verify the critical workflow. Faites varier une contrainte et expliquez pourquoi le choix pourrait alors changer.

## Contre-exemple et erreur fréquente

Réciter des adjectifs comme scalable ou enterprise sans contrainte ni mesure ne défend aucune décision. Reproduisez le défaut avec une preuve locale avant de proposer une correction.
