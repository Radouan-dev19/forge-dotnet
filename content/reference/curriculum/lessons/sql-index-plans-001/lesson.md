...
Un index sert un motif de filtre et d’ordre ; il coûte en écriture et en espace. Un plan se vérifie par propriétés stables, jamais par un coût exact.

## Explication

Un index sert un motif de filtre et d’ordre ; il coûte en écriture et en espace. Un plan se vérifie par propriétés stables, jamais par un coût exact. La règle doit rester visible dans le nom des opérations, les bornes et les erreurs. Avant de coder, notez l’entrée, la sortie, les invariants et ce qui doit être refusé.

## Exemple commenté

Un index sur CustomerId puis OrderDate soutient le filtre client et l’ordre chronologique. L’exemple est volontairement petit : changez une borne et une valeur absente pour vérifier que le raisonnement, et non la donnée mémorisée, produit le résultat.

## Contre-exemple et erreur fréquente

Créer un index par requête sans mesurer les écritures produit redondance et maintenance inutile. Le contre-exemple doit être reproduit par un test qui échoue avant correction et réussit après.
