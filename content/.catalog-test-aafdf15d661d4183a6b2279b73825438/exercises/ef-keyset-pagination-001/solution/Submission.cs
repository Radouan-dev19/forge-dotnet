...
public static class Submission
{
    ...
    {
        // Zéro est le curseur de départ ; une page démesurée contourne la pagination.
        ...
        // Filtre strict — le curseur a déjà été lu — puis ordre posé par la requête avant la
        // limitation : sans lui, la base tronquerait un ordre d'arrivée que rien ne garantit.
        IQueryable<int> page = context.Orders
            .Where(order => order.OrderId > afterId)
