...
Le code hérité se dit **legacy code** — la définition qui fait mouche en entretien est celle de
Feathers : du code sans tests —, le remplacement morceau par morceau se dit **strangler fig
pattern**, le test qui photographie l'existant **characterization test**, et l'analyse
churn-complexité **hotspot analysis**. Les interrupteurs qui s'accumulent se disent **feature
flags**, et leur dette **flag debt**. Aucun outil n'est imposé ici : ces noms sont le lexique des
discussions de reprise — et l'entretien senior teste moins le geste que la capacité à nommer la
stratégie et son ordre.
