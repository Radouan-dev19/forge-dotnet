namespace ForgeDotNet.Domain.Cloud;

/// <summary>
/// Guide du chapitre Cloud publié : un document Markdown autonome, servi tel quel, hors parcours.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed record CloudGuide(
    string Id,
    int Version,
    string Title,
    string Summary,
